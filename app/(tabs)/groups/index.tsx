                        ...
                        {group.total_habits !== undefined && (
                          <View className="flex-row items-center gap-1">
                            ...
                            <Text className="text-text-secondary text-sm">
                              {group.total_habits} habit
                              {group.total_habits !== 1 ? "s" : ""}
                            </Text>
                          </View>
                        )}
                        {group.active_habits !== undefined &&
                          group.active_habits > 0 && (
                            <View className="flex-row items-center gap-1">
                              <Text className="text-lg">✅</Text>
                        ...
                        <View className="border-t border-gray-100 pt-3">
                          <View className="flex-row items-center justify-between">
                            ...
                            <Text className="text-text-primary text-xs font-medium">
                              {new Date(group.next_checkin).toLocaleDateString(
                                "en-US",
                                {
                                  weekday: "short",
                                  month: "short",
                        ...
                        <View className="mt-3">
                          ...
                          <View className="h-2 bg-gray-200 rounded-full overflow-hidden">
                            <View
                              ...
                              style={{
                                width: `${group.completion_rate * 100}%`,
                              }}
                            />
                          </View>
                        </View>
